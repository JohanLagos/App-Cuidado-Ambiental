...
class ClasificacionAvanzada extends StatelessWidget {
  const ClasificacionAvanzada({super.key});
                ...
                child: Column(
                  children: [
                    ...
                    GFAccordion(
                      ...
                      contentBackgroundColor: Colors.green.shade900,
                      // titleBorderRadius: BorderRadius.circular(20),
                      titleBorder: Border.all(
                          color: Colors.green.shade900,
                          width: 2,
                          style: BorderStyle.solid),
                      collapsedTitleBackgroundColor: Colors.green.shade900,
                      expandedTitleBackgroundColor: Colors.green.shade900,
                    ),
                    ...
                    GFAccordion(
                      ...
                      contentBackgroundColor: Colors.red.shade900,
                      // titleBorderRadius: BorderRadius.circular(20),
                      titleBorder: Border.all(
                          color: Colors.red.shade900,
                          width: 2,
                          style: BorderStyle.solid),
                      collapsedTitleBackgroundColor: Colors.red.shade900,
                      expandedTitleBackgroundColor: Colors.red.shade900,
                    ),
                  ],
                ),
              )
